...
parser.add_argument("--output_path",type=str,default="/home/kai/wangzhongqi/Landscope_GAN/pic2",help='Local path of images')
parser.add_argument("--texture_path",type=str,default="/home/kai/wangzhongqi/train_data/",help='Local path of textures')
...
# Create the dataset
dataset = FramesDataset2(opt,dataset='alice',transform=transform)
...
def sample_images(batches_done):
    ...
    cv2.imwrite("images2/%s/%s.png" % (opt.dataset_name, batches_done),255*img_sample[0].squeeze(0).cpu().swapaxes(0,2).swapaxes(0,1).numpy())
